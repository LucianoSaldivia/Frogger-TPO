...
enum MYKEYS {
	KEY_UP, KEY_DOWN, KEY_LEFT, KEY_RIGHT, KEY_2_UP, KEY_2_DOWN, KEY_2_LEFT, KEY_2_RIGHT
};
...
#define X_INI_FROG_1 ( X_INI_FROG - ( 2 * BOUNCE_X ) )
#define X_INI_FROG_2 ( X_INI_FROG + ( 2 * BOUNCE_X ) )
